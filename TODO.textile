...
* Implement new index definition syntax
* implement to new UpdateOperation http://code.google.com/p/morphia/wiki/Updating - Create an
UpdateOperation and introduce a dsl which calls methods of updateoperation - breaking change
* check out "GORM Redis":http://grails.org/plugin/redis plugin and the "inconsequential":http://github.com/grails/inconsequential implementation
